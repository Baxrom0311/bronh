...
export function AppShell() {
  ...
  const navItems: Array<{
    ...
    ...(isPatient
      ? [
          { to: "/app/patients", label: t("nav.myProfile"), icon: UserIcon },
          { to: "/app/symptoms", label: t("nav.mySymptoms"), icon: Stethoscope },
          { to: "/app/diagnoses", label: t("nav.myHistory"), icon: History },
        ]
      : [
