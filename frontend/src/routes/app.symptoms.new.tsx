        ...
        <form onSubmit={onSubmit} className="space-y-6">
          ...
          <div>
            <div className="flex items-center gap-2 mb-3 pb-2 border-b border-border/50">
              ...
              <h3 className="font-semibold text-sm">{t("symptoms.vitalSigns")}</h3>
            </div>
          ...
          <div>
            <div className="flex items-center gap-2 mb-3 pb-2 border-b border-border/50">
              ...
              <h3 className="font-semibold text-sm">{t("symptoms.mainSymptoms")}</h3>
            </div>
            <div className="grid grid-cols-2 gap-3">
              <SelectField
          ...
          <div>
            <div className="flex items-center gap-2 mb-3 pb-2 border-b border-border/50">
              ...
              <h3 className="font-semibold text-sm">{t("symptoms.otherFactors")}</h3>
            </div>
